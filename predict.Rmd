...
We will split the original training data in order to have two data slices: one to train the model and another to validate the model. Besides, we will be able to estimate the out-of-sample error rate.
