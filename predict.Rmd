...
From the results above, we estimate that the accurary of the model when applied to the test data is: `r sprintf('%.2f%%', acc * 100)`, which is the average percentage of observation that were correctly classified in the cross validation process.
...
```{r}
train_data %>%
  ggplot(aes(x = pitch_forearm , colour = classe)) +
