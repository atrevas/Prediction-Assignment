...
From the results above, we estimate that the out of sample error rate of the model when applied to the test data is: `r sprintf('%.2f%%', err_rate * 100)`, which is the average percentage of observation that were incorrectly classified in the cross validation process.
